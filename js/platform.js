...
*/
  var t = this || self,
    ...
    ua = function (a) {
      ...
      try {
        b = c.createPolicy(a, { createHTML: ta, createScript: ta, createScriptURL: ta });
      } catch (d) {
...
*/
  ...
  var Qa = function (a, b) {
    ...
    if (e && "undefined" != typeof e[b] && (!a || (!(a instanceof e[b]) && (a instanceof e.Location || a instanceof e.Element)))) {
      ...
      Aa("Argument is not a %s (or a non-Element, non-Location mock); got: %s", b, f);
    }
    return a;
  };
  var Sa = function (a, b) {
    ...
    Ra = { cellpadding: "cellPadding", cellspacing: "cellSpacing", colspan: "colSpan", frameborder: "frameBorder", height: "height", maxlength: "maxLength", nonce: "nonce", role: "role", rowspan: "rowSpan", type: "type", usemap: "useMap", valign: "vAlign", width: "width" },
    Ta = function (a, b, c, d) {
      function e(k) {
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  var x = window,
    ...
    C = function () {
      var a;
      if ((a = Object.create) && $a.test(a)) a = a(null);
      else {
        a = {};
  ...
  var H = function (a, b, c) {
    ...
    lb = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g,
    mb = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source, "g"),
  ...
  var xb = function (a, b, c, d) {
    ...
    Ab = function (a) {
      if (yb()) a();
        ...
        x.addEventListener
          ? (x.addEventListener("load", c, !1), x.addEventListener("DOMContentLoaded", c, !1))
          : x.attachEvent &&
  ...
  var Qb = /^(\/[a-zA-Z0-9_\-]+)+$/,
      ...
      try {
        ...
        if (e && 0 < e.length) {
          ...
          for (d = {}; c < e.length; ) {
            var l = e[c++];
            f = void 0;
            f = ma(l) ? "o" + ((Object.prototype.hasOwnProperty.call(l, na) && l[na]) || (l[na] = ++oa)) : (typeof l).charAt(0) + l;
    ...
    ac = function (a, b, c, d) {
      ...
      return [encodeURIComponent(a.pathPrefix).replace(/%2C/g, ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.U ? "/am=" + e(a.U) : "", a.aa ? "/rs=" + e(a.aa) : "", a.ca ? "/t=" + e(a.ca) : "", "/cb=", e(c)].join("");
    },
    Zb = function (a) {
      ...
      e = bc(a, "rs");
      a = bc(a, "t");
      return { pathPrefix: b, version: c, U: d, aa: e, ca: a };
    },
    $b = function (a) {
  ...
  var oc = function (a) {
    ...
    O = function (a, b, c) {
      if (b && "object" === typeof b) for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || (c && "___goc" === d && "undefined" === typeof b[d]) || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !qc(a[d]) && !qc(b[d]) ? O(a[d], b[d]) : b[d] && "object" === typeof b[d] ? ((a[d] = qc(b[d]) ? [] : {}), O(a[d], b[d])) : (a[d] = b[d]));
    },
    rc = function (a) {
      if (a && !/^\s+$/.test(a)) {
    ...
    tc = function (a) {
      ...
      for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") || (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? ((g = f.nodeType), (f = 3 == g || 4 == g ? f.nodeValue : f.textContent || "")) : (f = void 0), (f = rc(f)) && b.push(f));
      a && sc(c, a);
      d = oc("cd");
      a = 0;
  ...
  var wc = { callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1 },
    xc = !1,
    yc = C(),
    zc = function () {
      if (!xc) {
  ...
  var Hc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
    ...
    Jc = function () {
      ...
      "string" === typeof a && 254 < a.length && (a = null);
      null == a && ((b = window.location.href), (a = H(b, "authuser") || null), null == a && (a = (a = b.match(Hc)) ? a[1] : null));
  ...
  var Lc,
    ...
    X = function (a, b) {
      ...
      if ("undefined" !== d) {
        ...
        b = [];
        var e = W(a);
        if (null != a && "function" === typeof a.toJSON && (Object.prototype.hasOwnProperty.call(a, "toJSON") || ((e !== Rc || (a.constructor !== Array && a.constructor !== Object)) && (e !== Qc || (a.constructor !== Array && a.constructor !== Object)) && e !== Pc && e !== Mc && e !== Oc && e !== Nc))) return X(a.toJSON.call(a), c);
    ...
    jd = function () {
      ...
      if ((void 0 === Lc || void 0 === U || T !== a) && -1 !== T) {
        ...
        try {
          try {
            U = !!t.JSON && '{"a":[3,true,"1970-01-01T00:00:00.000Z"]}' === t.JSON.stringify.call(t.JSON, { a: [3, !0, new Date(0)], c: function () {} }) && !0 === V("true") && 3 === V('[{"a":3}]')[0].a;
          } catch (b) {}
          Lc = U && !V("[00]") && !V('"\u0007"') && !V('"\\0"') && !V('"\\v"');
        } finally {
          T = a;
  ...
  var Fd = { allowtransparency: "true", frameborder: "0", hspace: "0", marginheight: "0", marginwidth: "0", scrolling: "no", style: "", tabindex: "0", vspace: "0", width: "100%" },
    ...
    Jd = function (a, b, c, d, e) {
      ...
      try {
        ...
        f ||
          ((f = (a ? new Wa(Va(a)) : wa || (wa = new Wa())).ha("IFRAME")),
          g &&
            ((f.onload = function () {
              f.onload = null;
              g.call(this);
  ...
  var Kd = /^:[\w]+$/,
    ...
    Md = function () {
      ...
      return (wb = { socialhost: f, ctx_socialhost: d ? g : f, session_index: a, session_delegate: b, session_prefix: c, im_prefix: e });
    },
    Nd = function (a, b) {
      return Md()[b] || "";
    },
  ...
  var Rd = { se: "0" },
    Sd = { post: !0 },
    Td = { style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none" },
    ...
    Zd = function (a) {
      for (var b = C(), c = 0 != a.nodeName.toLowerCase().indexOf("g:"), d = 0, e = a.attributes.length; d < e; d++) {
        var f = a.attributes[d],
          g = f.name,
          k = f.value;
        0 <= ab.call(Xd, g) || (c && 0 != g.indexOf("data-")) || "null" === k || ("specified" in f && !f.specified) || (c && (g = g.substr(5)), (b[g.toLowerCase()] = k));
      }
      a = a.style;
    ...
    be = function () {
      ...
      Fc(function (b) {
        if (a !== b.id && 4 != b.state && "share" != b.type) {
          ...
          if (f) {
            var g = Wd(d, b, 0);
            g ? ((f = f.parentNode), $d(e) !== $d(g) && ((b.dontclear = !0), (b.rd = !0), (b.ri = !0), (b.type = d), ae(f, b), (d = R[f.lastChild.id]) && (d.oid = c), Gc(c, 4))) : delete R[c];
          } else delete R[c];
        }
      });
    },
  ...
  var ce,
    ...
    fe,
    ge = /(?:^|\s)g-((\S)*)(?:$|\s)/,
    he = { plusone: !0, autocomplete: !0, profile: !0, signin: !0, signin2: !0 };
  ce = B(I, "SW", C());
  de = B(I, "SA", C());
  Y = B(I, "SM", C());
  ee = B(I, "FW", []);
  ...
  var ie = function (a, b) {
    ...
    je = function (a, b, c, d) {
      ...
      if (le(fe || {}))
        ...
        d = [];
        for (A in c) for (a = c[A], z = 0, b = a.length; z < b; z++) (e = a[z]), ne(A, e, Zd(e), d, b);
        oe(r, d);
      }
    },
    pe = function (a) {
      ...
      switch (te(b, a, f)) {
        ...
        case 1:
          if (b.parentNode) {
            ...
            b = c.ownerDocument || y;
            h = 0;
            do g = f.id || ["I", Hd++, "_", new Date().getTime()].join("");
      ...
      function d(f) {
        ...
        if (Ae(g, b)) {
          ...
          Be(a, function () {
            h && K("rqd");
            c();
            for (var l = B(I, "RPMQ", []), n = 0; n < l.length; n++) l[n]({ data: g, origin: k });
          });
        }
      }
      if (0 !== b.length) {
  ...
  function Ke(a) {
    ...
    d = "E" === c && e.l;
    return (!d && ("U" !== c || e.l)) || (d && !Ge) ? b : { X: !0, l: d, na: a.substr(1), domain: e.domain, o: e.o };
  }
  var Le = function (a) {
      if (!a) return [];
      a = a.split("=");
    ...
    Me = function (a) {
      a = a.split(":");
      return { clientId: a[0].split("=")[1], la: Le(a[1]), qa: Le(a[2]), pa: Le(a[3]) };
    },
    Ne = function () {
      var a = Je(),
        b = a.ga;
      ...
      if (null !== a) {
        ...
        if (c) {
          var d = Me(c),
            e = d && d.la[Number(a)];
          d = d && d.clientId;
          if (e) return { K: a, ka: e, clientId: d };
        }
      }
      return null;
    };
